...
public class ErroresdeConexion {
    ...
    public static String MessageError(int errorcode,String sqlexception){
        String errornombre="";
        switch(errorcode){
            case 1005 ://System.out.println("Controller.Controller_Producto.Add_Productos()"+ex.getErrorCode());
            ...
            case 1062 :    
                errornombre="EXISTE CODIGO ";break;
            case 1063 :
            ...
            case 1451 :    
                errornombre="EXISTE RELACION CON TABLAS";break;
            case 1452 :    
                errornombre="NO EXISTE CODIGO";break;
            case 2000 :
            ...
            case 2627 :    
                errornombre="EXISTE EL CODIGO";break;
            default :
