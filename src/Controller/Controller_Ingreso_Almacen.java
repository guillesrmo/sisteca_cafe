...
import View.View_Ingreso_Productos;
 ...
 * @author memo
 */
public class Controller_Ingreso_Almacen {
    ...
    private int getselection_guia = 0;
    private boolean[] editable_guia = {false, false, false, true};
    DefaultTableModel model_guia;

    /*private generador_codigo generador_id;
    Function_ShowMessageDialog mensaje = new Function_ShowMessageDialog();*/
    public Controller_Ingreso_Almacen() {
        cxn = new Conexion();
    ...
    public void reset_variable_guia() {
        getselection = 0;
    }

    public int variable_guia() {
        return getselection;
    }
    ...
    public String table_produto_busqueda(JTable clasificacion_producto, String busqueda) {
        ...
        try {
            ...
            String sSQL1 = "sELECT	pre.present_id \n"
                    ...
                    + ",pre.present_cantidad , uni.unidad_cod\n"
            ...
            model.setColumnIdentifiers(new Object[]{"", "", "COD_BARRA", "DESCRIPCIÒN", "PRESENTACION", "PRECIO_COMPR", "MARCA"});
            int contador = 0;
            while (rs.next()) {
                contador++;
                model.addRow(new Object[]{contador, rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4) + " X " + rs.getString(5), rs.getString(6), rs.getString(7)});
            }
            ...
            clasificacion_producto.getColumnModel().getColumn(4).setMaxWidth(120);
            clasificacion_producto.getColumnModel().getColumn(4).setMinWidth(120);
            clasificacion_producto.getColumnModel().getColumn(4).setPreferredWidth(120);
            clasificacion_producto.getColumnModel().getColumn(5).setMaxWidth(0);
            clasificacion_producto.getColumnModel().getColumn(5).setMinWidth(0);
            clasificacion_producto.getColumnModel().getColumn(5).setPreferredWidth(0);
            clasificacion_producto.getColumnModel().getColumn(6).setMaxWidth(120);
            clasificacion_producto.getColumnModel().getColumn(6).setMinWidth(120);
            clasificacion_producto.getColumnModel().getColumn(6).setPreferredWidth(120);
    ...
    public String Add_guia_compra(String id, String compra, String guia) {
        String respueta = "";
        String sent = "EXEC	[dbo].[InsertaTablaguiacompra]\n"
                + "		@guia_id = N'" + id + "',\n"
                + "		@guia_compra = N'" + compra + "',\n"
                + "		@guia_decr = N'" + guia + "'";
        try {
            cxn.conectardb().createStatement().executeUpdate(sent);
            cxn.desconectar();
    ...
    public String Add_compra(Entity_Compra compra) {
        ...
        String sent = "EXEC	 [dbo].[InsertaTablacompra]\n"
                ...
                + "		@compra_concepto =N'" + compra.getCompra_concepto() +   "',\n"
                    + "		@compra_entrega =N'" + compra.getEntrega_id()+ "'";
    ...
    public String Add_compra_producto_detalle(Entity_Compra_Producto detalle_compra) {
        ...
        String sent = "DECLARE	@return_value int\n"
                ...
                + "		@det_com_pro_fecha_produc = N'" + detalle_compra.getDet_com_pro_fecha_produc() + "'";
    ...
    public String delete_compra_guia(String guia) {
        String respuesta = "";
        String sent = "delete from guia_compra where guia_id='" + guia + "'";
    ...
    public void add_presentacion(JTable tabla, JDialog dialog_producto, JTable tabla_producto, JDialog dialog_igv, JTable tabla_igv, String id_Afectacion, String afectacion, String valor_afectacion, String valor_cod_afectacion) {
        ...
        model = new DefaultTableModel(new Object[]{"ELI", "ID_PROD_COMPR", "ID_PROD", "COD BARRA", "DESCRIPCION", "MEDIDA", "ID_IGV",
            "IGV", "IGV_VALOR", "AFECTACION", "CANTIDAD", "PRECIO COMP", "SUB_TOTAL", "PRECIO TOTAL", "DESC %", "DESC VALOR", "FECHA VENCIMIENTO", "FECHA RPODUC", "COD LOTE", "STOCK"}, 0) {
        ...
        settext_p_fecha_produccion(tabla, tabla.getColumnModel().getColumn(17), null);
        settext_cod_lote(tabla, tabla.getColumnModel().getColumn(18), null);
    ...
    public void compra_detalle(JTable tabla, JDialog dialog_producto, JTable table_producto, JDialog dialog_igv, JTable table_igv, String cod_compra) {
        ...
        try {
            String sSQL1 = " select \n"
                    ...
                    + "det_compra.det_com_pro_desc_ppr,det_compra.det_com_pro_des_Valor,det_compra.det_com_pro_fecha_venc,det_compra.det_com_pro_fecha_produc,det_compra.det_com_pro_cod_lote,					\n"
                ...
                public void keyPressed(KeyEvent evt) {
                    try {
                        ...
                        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                            ...
                            List<Entity_Producto_Presentacion> persona = new Controller_Ingreso_Almacen().buscar_cod_barra_producto_presentacion(txt_cod_barra.getText());
                        ...
                        if (evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_L) {
                            try {
                                if (tabla.getValueAt(tabla.getSelectedRow() + getselection, 2).toString().length() != 0) {
                                    ...
                                    Controller_Ingreso_Almacen almacen = new Controller_Ingreso_Almacen();
                                    if (almacen.table_lote(View_Ingreso_Productos.tabla_lote, tabla.getValueAt(tabla.getSelectedRow() + getselection, 2).toString()).equals("ERROR")) {
                                        Function_ShowMessageDialog.ShowMessageDialogvalidacion(null, "BUSQUEDA NO ENCONTRADA");

                                    } else {
                                        almacen.table_lote(View_Ingreso_Productos.tabla_lote, tabla.getValueAt(tabla.getSelectedRow() + getselection, 2).toString());
                                        Dimension desktopSize = View_Escritorio.desktopPane.getSize();
                                        Dimension FrameSize = View_Ingreso_Productos.Dialog_lote.getSize();
                                        View_Ingreso_Productos.Dialog_lote.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
                                        View_Ingreso_Productos.Dialog_lote.setVisible(true);
                                        tabla.editCellAt(tabla.getSelectedRow() + getselection, 10);
                                        Component aComp = tabla.getEditorComponent();
                                        aComp.requestFocus();
                                        View_Ingreso_Productos.tabla_lote.requestFocus();
        ...
        try {
            ...
            txt_cantidad.addKeyListener(new KeyListener() {
                ...
                public void keyPressed(KeyEvent evt) {
                    ...
                    if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                        if (txt_cantidad.getText().length() != 0 && Double.parseDouble(txt_cantidad.getText()) > 0) {
    ...
    public void settext_p_fecha_produccion(JTable tabla, TableColumn columna, JDialog dialogo) {
        ...
        try {
            ...
            JTextField txt_p_fecha = new JTextField();
            Function_Component.JTextField(txt_p_fecha);
            Function_Key_Event.Validar_Mayuscula(txt_p_fecha);
            columna.setCellEditor(new DefaultCellEditor(txt_p_fecha));
            DefaultTableCellRenderer render = new DefaultTableCellRenderer();
            txt_p_fecha.addKeyListener(new KeyListener() {
                @Override
    ...
    public void add_guia_compra(JTable tabla) {
        JButton btnEliminar = new JButton("");
        btnEliminar.setName("btneliminar");
        btnEliminar.setIcon(new ImageIcon("src\\Icon\\icon_eliminar.png"));
        tabla.setDefaultRenderer(Object.class, new Render());
        model_guia = new DefaultTableModel(new Object[]{"ELI", "ID_GUIA", "GUIA_COMPRA", "GUIA"}, 0) {
            ...
            @Override
            public boolean isCellEditable(int row, int column) {
                return editable_guia[column];
            }
        };
        model_guia = (DefaultTableModel) tabla.getModel();
        model_guia.addRow(new Object[]{btnEliminar, "", "", ""});

        tabla.setModel(model_guia);
        Function_Key_Event.Validar_numeros_jtable(tabla);
        ...
        settext_comrpa_guia(tabla, tabla.getColumnModel().getColumn(3));
    ...
    public void guia_compra(JTable tabla, String cod_compra) {
        JButton btnEliminar = new JButton("");
        btnEliminar.setName("btneliminar");
        btnEliminar.setIcon(new ImageIcon("src\\Icon\\icon_eliminar.png"));
        tabla.setDefaultRenderer(Object.class, new Render());
        ...
        try {
            String sSQL1 = "SELECT [guia_id]\n"
                    + "      ,[guia_compra]\n"
                    + "      ,[guia_decr]\n"
                    + "  FROM [guia_compra] where guia_compra='" + cod_compra + "'\n"
                    + "  order by guia_id asc";
            ResultSet rs = cxn.conectardb().createStatement().executeQuery(sSQL1);

            while (rs.next()) {
                model_guia.addRow(new Object[]{btnEliminar, rs.getString(1), rs.getString(2), rs.getString(3)});
    ...
    public void settext_comrpa_guia(JTable tabla, TableColumn columna) {

        JTextField txt_p_desc_valor = new JTextField();
        Function_Component.JTextField(txt_p_desc_valor);
        Function_Key_Event.Validar_Mayuscula(txt_p_desc_valor);
        columna.setCellEditor(new DefaultCellEditor(txt_p_desc_valor));
        DefaultTableCellRenderer render = new DefaultTableCellRenderer();
        txt_p_desc_valor.addKeyListener(new KeyListener() {
            @Override
    ...
    public List<Entity_Persona> buscar_persona(String buscar) {
        ...
        String sent = "select per.persona_id,per.persona_tipo_documento,per.persona_ruc,per.persona_dni,per.persona_razon_social,per.persona_razon_comercial,\n"
                + "				per.persona_direccion,doc.documento_id,doc.documento_cod,doc.documento_descrip,doc.documento_url from persona per\n"
