 ...
 * @author pro
 */
public class View_Cardex_Fisico_X_LOTE extends javax.swing.JInternalFrame {
     ...
     */
    public View_Cardex_Fisico_X_LOTE() {
        initComponents();
        Date date = new Date();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("").getAbsolutePath()
                    + "/src/Reportes/Jaspersoft_Cardex_Lote.jrxml");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(View_Cardex_Fisico_X_LOTE.class.getName()).log(Level.SEVERE, null, ex);
        }
