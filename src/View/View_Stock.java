...
public class View_Stock extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        Check2.setText("Mostra por almacen");

        Check1.setSelected(true);
        Check1.setText("Mostra todo los productos");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JasperPrint print;
            ...
            } else if (Check1.isSelected()==true&&Check2.isSelected()==false) {
                report = JasperCompileManager.compileReport(new File("").getAbsolutePath()
                    + "/src/Reportes/Jaspersoft_Stock_sin_almacen.jrxml");
            }else if (Check1.isSelected()==false&&Check2.isSelected()==true) {
                report = JasperCompileManager.compileReport(new File("").getAbsolutePath()
                    + "/src/Reportes/Jaspersoft_Stock.jrxml");
            }else if (Check1.isSelected()==false&&Check2.isSelected()==false) {
                report = JasperCompileManager.compileReport(new File("").getAbsolutePath()
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (Check1.isSelected()==true) {
            ...
            mostrar_todo="where producto.producto_id BETWEEN '"+txt_id_producto1.getText()+"' and '"+txt_id_producto2.getText()+"'";
        }
        ...
        stock.tabla_producto(tabla_producto,mostrar_todo,mostrar_almacen_com,mostrar_almacen_ven);
