 ...
 * @author memo
 */
public class View_Ingreso_Productos extends javax.swing.JInternalFrame {
     ...
     */
    Controller_Ingreso_Almacen almacen = new Controller_Ingreso_Almacen();

    public View_Ingreso_Productos() {
        initComponents();
        ...
        almacen.guia_compra(tabla_guia, TITLE_PROPERTY);
        ...
        Function_Component.JCheckBox(check_guia);
    ...
    private void initComponents() {
        ...
        Dialog_guia = new javax.swing.JDialog();
        ...
        check_guia = new javax.swing.JCheckBox();
        ...
        Dialog_guia.setTitle("GUIA");
        Dialog_guia.setMinimumSize(new java.awt.Dimension(340, 246));
        Dialog_guia.setModal(true);
        Dialog_guia.setResizable(false);
        ...
        jScrollPane5.setViewportView(tabla_guia);
        ...
        javax.swing.GroupLayout Dialog_guiaLayout = new javax.swing.GroupLayout(Dialog_guia.getContentPane());
        Dialog_guia.getContentPane().setLayout(Dialog_guiaLayout);
        Dialog_guiaLayout.setHorizontalGroup(
            Dialog_guiaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Dialog_guiaLayout.createSequentialGroup()
                .addComponent(jPanel25, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        Dialog_guiaLayout.setVerticalGroup(
            Dialog_guiaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel25, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        ...
        jScrollPane6.setViewportView(tabla_lote);
        ...
        jPanel24.setBorder(javax.swing.BorderFactory.createTitledBorder("Concepto"));
        ...
        jPanel24Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(cbx_concepto, 0, 361, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel24Layout.setVerticalGroup(
            ...
            .addGroup(jPanel24Layout.createSequentialGroup()
                .addGap(4, 4, 4)
                .addComponent(cbx_concepto, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        jPanel29Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel29Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(cbx_entrega, 0, 351, Short.MAX_VALUE))
        );
        jPanel29Layout.setVerticalGroup(
            ...
            .addGroup(jPanel29Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel29Layout.createSequentialGroup()
                    .addComponent(cbx_entrega, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        check_guia.setText("ESTADO GUIA");
        check_guia.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                check_guiaKeyPressed(evt);
            }
        });
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(cbx_tipoafectacion, javax.swing.GroupLayout.PREFERRED_SIZE, 340, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(check_guia, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(cbx_tipoafectacion, javax.swing.GroupLayout.DEFAULT_SIZE, 33, Short.MAX_VALUE)
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jButton1, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(check_guia, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
    ...
    private void txt_busqueda_compra_codKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_busqueda_compra_codKeyPressed
        ...
        try {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                List<Entity_Compra> compra = new Controller_Ingreso_Almacen().buscar_compra(txt_busqueda_compra_cod.getText());
                if (compra.size() == 0) {
                    deshabilitar_compra();
                    nuevo_compra();
                    almacen.compra_detalle(table_productos_compra, Dialog_producto, tabla_productos, Dialog_afectacion, tabla_afectacion, TITLE_PROPERTY);
                ...
                cbx_concepto.getModel().setSelectedItem(new Entity_Concepto(compra.get(0).getConcepto_id(),
                        compra.get(0).getConcepto_cod(), compra.get(0).getConcepto_desc()));
                ...
                almacen.guia_compra(tabla_guia, compra.get(0).getCompra_id());
                cbx_entrega.getModel().setSelectedItem(new Entity_Entrega(compra.get(0).getEntrega_id(),
                        compra.get(0).getEntrega_desc(), compra.get(0).getEntrega_año()));
                habilitar_compra();
    ...
    private void tabla_productosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_productosMouseClicked
        ...
        table_productos_compra.setValueAt(tabla_productos.getValueAt(tabla_productos.getSelectedRow(), 5), table_productos_compra.getSelectedRow() + almacen.variable(), 11);
    ...
    private void btn_registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_registrarActionPerformed
        ...
        if (check_guia.isSelected() == true) {
            if (tabla_guia.getRowCount() == 0) {
            JOptionPane.showMessageDialog(rootPane, "DEBE CONTENER MAS DE UNA FILA LA TABLA DE GUIA O DESMARQUE \"ESTADO DE GUIA\"");
            return;

        }
            tabla_guia.editCellAt(0, 3);
            Component aCompa = tabla_guia.getEditorComponent();
            aCompa.requestFocus();
            for (int j = 0; j < tabla_guia.getRowCount(); j++) {
                try {

                    for (int i = 3; i <= tabla_guia.getColumnCount(); i++) {
                        if (tabla_guia.getValueAt(j, i).toString() == ("")) {
                            JOptionPane.showMessageDialog(rootPane, "HAY CAMPO VACIO:" + tabla_guia.getTableHeader().getColumnModel().getColumn(i).getHeaderValue());
                            tabla = tabla + 1;
                            tabla_guia.editCellAt(j, i);
                            Component aComp1 = tabla_guia.getEditorComponent();
                            aComp1.requestFocus();
                            break;

                        } else if (tabla_guia.getValueAt(j, i).toString().length() == 0) {
                            JOptionPane.showMessageDialog(rootPane, "HAY CAMPO VACIO:" + tabla_guia.getTableHeader().getColumnModel().getColumn(i).getHeaderValue());
                            tabla = tabla + 1;
                            tabla_guia.editCellAt(j, i);
                            Component aComp1 = tabla_guia.getEditorComponent();
        ...
        compra = new Entity_Compra(txt_id_compra.getText(), ((Entity_Tipo_Comprobante) cbx_tipo_comprobante.getSelectedItem()).getComprobante_id(),
                ...
                txt_gratuito.getText(), txt_otras_cargas.getText(), txt_total.getText(), txt_tipo_cambio.getText(), ((Entity_Documento) cbx_compra_documento.getSelectedItem()).getDocumento_id(),
        ...
        if (almacen.Add_compra(compra).equals("exito")) {
            ...
            for (int i = 0; i < table_productos_compra.getRowCount(); i++) {
                detalle_compra = new Entity_Compra_Producto(
                        ...
                        table_productos_compra.getValueAt(i, 16).toString(), table_productos_compra.getValueAt(i, 18).toString(),
                        table_productos_compra.getValueAt(i, 17).toString());
                almacen.Add_compra_producto_detalle(detalle_compra);
            }

            for (int i = 0; i < tabla_guia.getRowCount(); i++) {
                almacen.Add_guia_compra(tabla_guia.getValueAt(i, 1).toString(), txt_id_compra.getText(), tabla_guia.getValueAt(i, 3).toString());
            }
    ...
    private void tabla_compraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tabla_compraKeyPressed
        ...
        try {
            ...
            if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
                ...
                List<Entity_Compra> compra = new Controller_Ingreso_Almacen().buscar_compra(tabla_compra.getValueAt(tabla_compra.getSelectedRow(), 0).toString());
                Date date1 = new SimpleDateFormat("yyyy-MM-dd").parse(compra.get(0).getCompra_fecha_emis());
                Date date2 = new SimpleDateFormat("yyyy-MM-dd").parse(compra.get(0).getCompra_fecha_ingreso_alm());
                Date date3 = new SimpleDateFormat("yyyy-MM-dd").parse(compra.get(0).getCompra_fecha_vencimiento());
                Date date4 = new SimpleDateFormat("yyyy-MM-dd").parse(compra.get(0).getCompra_fecha_contable());
                ...
                if (compra.get(0).getDocumento_cod().equals("6")) {
                    txt_compra_DNI_RUC.setText(compra.get(0).getPersona_ruc());
                } else if (compra.get(0).getDocumento_cod().equals("1")) {
                    txt_compra_DNI_RUC.setText(compra.get(0).getPersona_dni());
                }
    ...
    private void table_productos_compraKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_table_productos_compraKeyPressed
        ...
        if (evt.isControlDown() && evt.getKeyCode() == KeyEvent.VK_P) {
            ...
            if (almacen.table_produto_busqueda_presentacion(tabla_productos, table_productos_compra.getValueAt(table_productos_compra.getSelectedRow() + almacen.variable(), 3).toString()).equals("ERROR")) {
                ...
                View_Ingreso_Productos.btn_calcular.doClick();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Dimension desktopSize = View_Escritorio.desktopPane.getSize();
        Dimension FrameSize = Dialog_guia.getSize();
        Dialog_guia.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
        Dialog_guia.setVisible(true);
                   
        } else {
            Function_ShowMessageDialog.ShowMessageDialogvalidacion(null, "ACTIVE CHECK GUIA");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        almacen.add_guia_compra(tabla_guia);
            ...
            if (value instanceof JButton) {
                ...
                if (boton.getName().equals("btneliminar")) {
                    ...
                    if (tabla_guia.getSelectedRow() != -1) {
                        /*DefaultTableModel model = (DefaultTableModel) tabla_productos_presentacion.getModel();
                        model.removeRow(tabla_productos_presentacion.getSelectedRow());*/
                        if (tabla_guia.getValueAt(fila, 1).toString().equals("")) {
                            DefaultTableModel model = (DefaultTableModel) tabla_guia.getModel();
                            model.removeRow(tabla_guia.getSelectedRow());
                        } else if (tabla_guia.getValueAt(fila, 1).toString().equals(null)) {
                            System.out.println("1");
                        } else {
                            almacen.delete_compra_guia(tabla_guia.getValueAt(tabla_guia.getSelectedRow(), 1).toString());
                            DefaultTableModel model = (DefaultTableModel) tabla_guia.getModel();
                            model.removeRow(tabla_guia.getSelectedRow());
                        }
                    } else {
    ...
    private void check_guiaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_check_guiaKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_check_guiaKeyPressed
    ...
    private void tabla_loteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_loteMouseClicked
        // TODO add your handling code here:
        table_productos_compra.setValueAt(tabla_lote.getValueAt(tabla_lote.getSelectedRow(), 1), table_productos_compra.getSelectedRow() + almacen.variable(), 16);
        table_productos_compra.setValueAt(tabla_lote.getValueAt(tabla_lote.getSelectedRow(), 2), table_productos_compra.getSelectedRow() + almacen.variable(), 18);
        table_productos_compra.setValueAt(tabla_lote.getValueAt(tabla_lote.getSelectedRow(), 0), table_productos_compra.getSelectedRow() + almacen.variable(), 17);
        Dialog_lote.dispose();
    ...
    private javax.swing.JDialog Dialog_guia;
    ...
    private javax.swing.JCheckBox check_guia;
