...
public class FixedColumnTable implements ChangeListener, PropertyChangeListener
{
	...
	public FixedColumnTable(int fixedColumns, JScrollPane scrollPane)
	{
		...
		main.addPropertyChangeListener( this );
               // Function_Component.JTable(fixed);
             //  
       /* fixed.setFont(fuente); 
        fixed.setForeground(Color.BLACK);
        fixed.setRowHeight(35);*/
              //  Function_Component.JTable(main);
		...
		for (int i = 1; i < fixedColumns; i++)
		{
                    fixed.getTableHeader().setFont(fuente);
                    fixed.setFont(fuente);
                     fixed.setForeground(Color.BLACK);
        fixed.setRowHeight(35);
